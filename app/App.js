...
import PaymentComponent from './Screen/Payment/payment';
import InputComponent from './Screen/InputDetails/imputDetail';
import CompleteOrderComponent from './Screen/CompleteOrder/CompleteOrder';
...
import RefundComponent from './Screen/Basic/Refund';
import CompareComponent from './Screen/ComparePrices/ComparePrices';
...
let CompareStack = (props) => {
  return (
    <Stack.Navigator
      mode="card"
      headerMode="screen"
      initialRouteName="CompareScreen">
      <Stack.Screen
        name="CompareScreen"
...
let RefundStack = (props) => {
  return (
    <Stack.Navigator
      mode="card"
      headerMode="screen"
      initialRouteName="RefundScreen">
      <Stack.Screen
        name="RefundScreen"
...
let CompleteOrderStack = (props) => {
  return (
    <Stack.Navigator
      mode="card"
      headerMode="screen"
      initialRouteName="CompleteOrderScreen">
      <Stack.Screen
